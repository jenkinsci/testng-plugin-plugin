...
public class FormatUtil {
    ...
    /**
     * Formats a long value and prepends it with a - or + This functions is used for showing the
     * diff values for test runs
     *
    ...
    /**
     * Replaces newline characters in string with {@code <br/>} to retain the newlines when the
     * string is displayed in HTML. It also replaces {@code <}, {@code >}, {@code &}, and {@code "}
     * characters with their corresponding html code. ref :
