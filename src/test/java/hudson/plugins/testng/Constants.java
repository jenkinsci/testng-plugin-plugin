...
public class Constants {
    ...
    /** Reporter log output for complete suite as well as test method specific output */
    ...
    public static final String TESTNG_MULTILINE_EXCEPTION_AND_DESCRIPTION =
            "testng-xml-multiline-exp-msg-and-descp.xml";
